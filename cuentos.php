        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="rapunzel.php">
                                <img src="img/cuentoRa.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Rapunzel</div>
                    </div>
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="caperucitaC.php">
                                <img src="img/cuentoCa.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Caperucita roja</div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="cerditosC.php">
                                <img src="img/cuentoCERDOS.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Los tres cerditos</div>
                    </div>
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="pinocho.php">
                                <img src="img/cuentopinocho.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Pinocho</div>
                    </div>
                </div>
