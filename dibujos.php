        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="lobos.php">
                                <img src="img/wolfIcon.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Dibujos de lobos</div>
                    </div>
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="gatos.php">
                                <img src="img/catIcon.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">dibujos de gatos</div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="unicornios.php">
                                <img src="img/unicornIcon.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Dibujos de unicornios</div>
                    </div>
                    <div class="col-6">
                        <div class="cuadrado d-flex justify-content-center shadow">
                            <a href="anime.php">
                                <img src="img/mangaIcon.png" alt="" style="width: 120px; height:130px; margin-top: 6px;"><i class="fa fa-camera"></i>
                            </a>
                        </div>
                        <div class="app-name">Dibujos de Anime / Manga</div>
                    </div>
                </div>
                ...
                <<div class="cuadrados-contenedor align-self-center rounded-5 shadow py-3 px-2 d-flex justify-content-between">
                    ...
                    <div class="cuadradoRojo d-flex align-items-center justify-content-center">
                        <a href="leonraton.php">
                            <img src="img/leonR.png" alt="" style="width: 120px; height:130px; margin-top: 6px;">
                        </a>
                    </div>
                    ...
                    <div class="cuadradoVerde d-flex align-items-center justify-content-center">
                        <a href="fabulas.php">
                            <img src="img/fabulasIcon.png" alt="" style="width: 120px; height:130px; margin-top: 6px;">
                        </a>
                    </div>
